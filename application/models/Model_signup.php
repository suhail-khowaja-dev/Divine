...
class Model_signup extends MY_Model
{
    ...
    function __construct()
    {
        ...
        $this->pagination_params['fields'] = "signup_id, signup_type, signup_firstname,signup_lastname, signup_email, signup_status";;
    ...
    public function getexportsignup($user_type){
        $response = array();
        $this->db->select('signup_id,signup_firstname,signup_lastname,signup_email,signup_static_password,signup_address,signup_city,signup_state,signup_zip,signup_phone,signup_name,signup_username,signup_country,signup_company,signup_business_name,signup_address2,created_on')->where('signup_type', $user_type);
        $query = $this->db->get('mt_signup');
    ...
    public function get_fields($specific_field = "")
    {
        ...
        $data =  array(
           ...
           /* 'signup_username' => array(
            ...
            'signup_consignor_fee' => array(
                'table' => $this->_table,
                'name' => 'signup_consignor_fee',
                'label' => 'Consinor Fee',
                'type' => 'text',
                'attributes' => array(),
                'js_rules' => '',
            ...
            'signup_hanger_fee' => array(
                'table' => $this->_table,
                'name' => 'signup_hanger_fee',
                'label' => 'Hanger Fee',
                'type' => 'text',
                'attributes' => array(),
                'js_rules' => '',
            ...
            'signup_consignor_percentage' => array(
                'table' => $this->_table,
                'name' => 'signup_consignor_percentage',
