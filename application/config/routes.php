...
$route['consignor'] = "user/register_consignor";
$route['volunteer'] = "user/register_volunteer";
$route['mailing-list'] = "mailing-list";
$route['forgot-password-client'] = "user/forgotpasswordclient";
