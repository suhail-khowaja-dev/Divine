    ...
    public function __construct()
    {
        ...
        if ($this->router->directory == "admin/") {
            ...
            if (isset($this->session->userdata['userdata']))
            {
                ...
                $this->adminid = $this->session->userdata['logged_in']['is_admin'];
            ...
            $this->adminid = 0;
            if (isset($this->session->userdata['logged_in']['is_admin'])) {
                $this->adminid = intval($this->session->userdata['logged_in']['is_admin']);
            }
