...
$menu_links = array(
    ...
    // array("title" => "Sale Reports", "icon" => "clip-transfer", "action" =>"", "link"=>"",
    //     "additionals" => array(
    //         //array("link" => "", "title" => "Dashboard", "icon" => "bar-chart"),
    //     ),
    // ),
    ...
    */
    ...
    // array("title" => "Layout", "icon" => "clip-screen", "action" => array("promotional_banner", "", "cms_page", "cms_title", "logo"),
    //     "additionals" => array(
...
// Testimonials
    ...
    array("title"=>"Sale Management", "icon"=>"clip-transfer" ,"action" => array("sale") ,
        "additionals"=>array(
            array("link"=>"sale","title"=>"Manage Sale", "icon"=>"basket"),

        ),
    ),


    array("title"=>"Shift Management", "icon"=>"clip-transfer" ,"action" => array("volunteer_shift_ref","volunteer_shift") ,
        "additionals"=>array(
            //array("link"=>"volunteer_shift_ref","title"=>"Manage Volunteer Shifts", "icon"=>"basket"),
            array("link"=>"volunteer_shift","title"=>"Manage Volunteer Shifts", "icon"=>"basket"),

        ),
    ),

    array("title"=>"Drop Off Management", "icon"=>"clip-transfer" ,"action" => array("view_sale_drop_ofss_registered","sale_dropoff","sale_dropoffs") ,
        "additionals"=>array(
            //array("link"=>"view_sale_drop_ofss_registered","title"=>"Manage Drop Offs", "icon"=>"basket"),
            //array("link"=>"sale_dropoff","title"=>"Manage Sale Drop Offs", "icon"=>"basket"),
            array("link"=>"sale_dropoffs","title"=>"Manage Sale Drop Offs", "icon"=>"basket"),

        ),
    ),


    array("title"=>"Sale Transactions", "icon"=>"clip-transfer" ,"action" => array("sale_transaction") ,
        "additionals"=>array(
            array("link"=>"sale_transaction","title"=>"Manage Transactions", "icon"=>"basket"),

        ),
    ),

    // array("title"=>"Financial Data", "icon"=>"clip-transfer" ,"action" => array("financial_data") ,
    //     "additionals"=>array(
    //         array("link"=>"financial_data","title"=>"Manage Financial Data", "icon"=>"basket"),

    //     ),
    // ),


    //  array("title"=>"Registered Sale", "icon"=>"clip-transfer" ,"action" => array("registered_sale","sale_dropoff","sale_dropoffs") ,
    //     "additionals"=>array(
    //         //array("link"=>"view_sale_drop_ofss_registered","title"=>"Manage Drop Offs", "icon"=>"basket"),
    //         //array("link"=>"sale_dropoff","title"=>"Manage Sale Drop Offs", "icon"=>"basket"),
    //         array("link"=>"registered_sale","title"=>"Manage Registere Sale", "icon"=>"basket"),
...
"),
    ...
    array("title" => "Subscribe", "icon" => " fa fa-bookmark", "action" => array("subscribe"),"link"=>"subscribe",
        "additionals" => array(
            array("link" => "subscribe", "title" => "Subscribe List", "icon" => " fa fa-user-plus"),
            ...
            //$selected = "";
                ...
                if($key==0){?>
                    <li class="">
                        ...
                        <li>
                            <a href="<?php echo $config['base_url']?>sale_report" target="_blank"><i class="fa fa-file-text" aria-hidden="true"></i>
