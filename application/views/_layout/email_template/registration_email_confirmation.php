        ...
        <table style="border-collapse:collapse;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    ...
                    <b><p>Hi,<?php echo $personal_data['signup_firstname']?>  <?= $personal_data['signup_lastname']?> </p></b>
                </td>
            </tr>
            <tr>
                <td>
                   
                    <b><p>We have recived your changes.Thank you.You can review your update information by logging in to your <a href=
                        "<?=g('base_url')?>user" target="_blank">account page</a></p></b>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        ...
                        <b><p>Please contact us with any questions.</p></b>
                    </td>
                </tr>
