...
<input type="hidden" name="comment[comment_post_id]" value="<?=$blog_details['blog_id']?>">   
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="text-leave">
                        ...
                        <!-- <button class="blue-btn" type="button"  onclick="ajaxcommentform('commentform')">Submit</button> -->
                      </div>
                    </div>
                  </div>
</form>
            ...
            <!-- <div class="col-sm-3">
              ...
              <div class="latest-posts">
                <div class="row">
                  <div class="col-md-5 col-sm-5 col-xs-4 latest-posts-img">
                    <img src="images/circle-two.png" alt="blog-img">
                  </div>
                  <div class="col-md-7 col-sm-7 col-xs-8 latest-posts-text pl-0"><a href="#">French fries share them with me</a><span>Dec 25, 2018</span></div>
                </div>
              </div>
              <div class="latest-posts">
                <div class="row">
                  <div class="col-md-5 col-sm-5 col-xs-4 latest-posts-img"><img src="images/circle-one.png" alt="blog-img" class="img-responsive"></div>
                  <div class="col-md-7 col-sm-7 col-xs-8 latest-posts-text pl-0"><a href="#">Tortillas Tacos crew the Minnow</a><span>Jan 07, 2019</span></div>
                </div>
              </div>
              ...
              <div class="archives">
                <ul>
                  <li><a href="#">September 2018   </a> <span>(25)</span></li>
                  <li><a href="#">October 2018 </a> <span>(18)</span></li>
                  <li><a href="#">November 2018    </a> <span>(12)</span></li>
                  <li><a href="#">December 2018    </a> <span>(20)</span></li>
                  <li><a href="#">December 2018    </a> <span>(35)</span></li>
                </ul>
              </div>
              <div class="blog-list-left-heading">
                <h4> item Tags</h4>
              ...
              <div class="mt-10">
                <ul class="list-inline">
                  <li> <a href="#" class="button-tag primary-button">Lorem</a></li>
                  <li ><a href="#" class="button-tag primary-button">Amet</a></li>
                  <li>  <a href="#" class="button-tag primary-button">dollor</a></li>
                  <li> <a href="#" class="button-tag primary-button">Lipsum</a></li>
                  <li> <a href="#" class="button-tag primary-button">Amet</a></li>
                  <li>  <a href="#" class="button-tag primary-button">lipsum</a></li>
                  <li> <a href="#" class="button-tag primary-button">dolor</a></li>
                  <li>  <a href="#" class="button-tag primary-button">lipsum</a></li>
                  <li> <a href="#" class="button-tag primary-button">dolor</a></li>
                </ul>
              </div>
