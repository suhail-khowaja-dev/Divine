...
<script type="text/javascript">
  ...
  $(function()
  {
      $('#financial_data-financial_data_user_id').on('change',function(){
              var id = $(this).val();

              var params = {};
              params.id = id;
              var res = AjaxRequest.fire($js_config.base_url + "admin/financial_data/get_registered_sale" , params);
              var selCat = [];

             if(res.status == 1)
             {
                  $('#financial_data-financial_data_registered_sale_id').html(res.html);
             }
             else
             {
                  $('#financial_data-financial_data_registered_sale_id').html('');                  
             }

             $("#financial_data-financial_data_registered_sale_id").select2("destroy");

            $("#financial_data-financial_data_registered_sale_id").select2();
