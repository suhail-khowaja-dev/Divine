    ...
    <div class="row">
      ...
      <!-- Profile image start -->
            <!--<div class="col-md-8">
              ...
              <!-- Profile image end -->
              <div class="col-md-12">
                <?php if($userdata['signup_type'] == 1){?>
                  <h3>Consignor #: <?= $userdata['signup_id'] ?></h3>
                  <?} else{?>
                    <h3>Volunteer #: <?= $userdata['signup_id'] ?></h3>
                  <?php }?>
                  <form action="<?= g('base_url') ?>account/update_info"
                    ...
                    <!--<div class="form-group col-md-6">
                        ...
                        <input type="text"
                             ...
                             <div class="form-group col-md-6">
                              ...
                              value="<?= $userdata['signup_lastname']  ?>"
                              placeholder="Last Name "
                              name="signup[signup_lastname]" required>
                            </div>
                    ...
                    <!-- <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text"
                        class="form-control my-form-control my-margin-bottom-15"
                        value="<?= ($userdata['signup_phone'] == 0) ? '' : $userdata['signup_phone'] ?>"
                        placeholder="Phone"
                        name="signup[signup_phone]" required>
                      </div>
